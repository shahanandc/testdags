...
io_1 = KubernetesPodOperator(namespace='default',
                          ...
                          resources={'request_memory': '26Gi', 'limit_memory': '26Gi'},      
                          image_pull_secrets='cpnprdacr',
                          arguments=["/mnt/cpmodeldata/ModelData/IOINSTALLVOLUME/code/IOINSTALLVOLUME_Forecasting_Model.R","DEV","YES","NO","NO","NO","7"],
                          labels={"foo": "bar"},
                          name="io_1",
                          task_id="io_1",
                          get_logs=True,
